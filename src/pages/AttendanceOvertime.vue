<template>
  <div class="edit-wrapper">
    ...
    <div class="edit-inner">
      ...
      <div class="edit-inner-group">
        <group class="required clearfix">
          <x-input title="加班时长" :value.sync="workExpItem.company" placeholder="请输入" :show-clear="false"><i class="ui-icon ui-icon-sm ui-icon-pen-gray-sm"></i></x-input>
        </group>
      </div>
      <div class="edit-inner-group">
        <group class="required clearfix">
          <cell title="加班事由"></cell> 
        </group> 
        <group class="group-textarea required clearfix">
          <x-textarea :rows="6" placeholder="请填写加班事由"></x-textarea>
        </group>
      </div>
    </div>
