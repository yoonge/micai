<template>
  <div class="user-social" :class="{'bottom-padding': userInfoStatus}">
    ...
    <div class="social-relationship-wrapper" v-if="result1">
      <a v-link="'/home/edit/userSocialRelationshipList'" class="btn-link btn-link-edit"><i class="ui-icon ui-icon-sm ui-icon-pen-blue-sm"></i>编辑</a>
    ...
    <div class="btn-wrapper" v-if="result2">
      <a v-link="'/home/edit/addUserSocialRelationship'" class="btn-add-work-exp">现在去添加</a>
    </div>
