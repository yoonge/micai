<template>
  <div class="user-work" :class="{'bottom-padding': userInfoStatus}">
    ...
    <div class="work-item-wrapper" v-if="result1">
      <a v-link="'/home/edit/userWorkListTemp'" class="btn-link btn-link-edit"><i class="ui-icon ui-icon-sm ui-icon-pen-blue-sm"></i>编辑</a>
    ...
    <div class="btn-wrapper" v-if="result2">
      <a v-link="'/home/edit/addUserWorkTemp'" class="btn-add-work-exp">现在去添加</a>
    </div>
